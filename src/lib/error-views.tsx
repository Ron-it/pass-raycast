...
import { SUPPORTS_BUNDLED_CLI, getCliNotInstalledDescription, getKeyringTroubleshootingMessage } from "./platform";
  ...
  switch (errorType) {
    case "not_installed":
      return {
        ...
        description: getCliNotInstalledDescription(),
        showDocsLink: true,
        showRetry: false,
      };
    ...
    case "keyring_error":
      return {
        ...
        description: getKeyringTroubleshootingMessage(),
        showDocsLink: true,
        showRetry: true,
      };
    case "network_error":
      ...
      <List.EmptyView
        ...
        actions={
          <ActionPanel>
            ...
            {SUPPORTS_BUNDLED_CLI && <ClearCliCacheAction onComplete={onRetry} />}
          </ActionPanel>
        }
      />
    </List>
